  ...
  <div class="my_favourite_song_wrapper">
    ...
    <div class="mfst_wrapper">
      ...
      <div class="mfst_right_wrapper">
        ...
        <div class="mfst_describe">
          ...
          <p>
            歌手: <span>{{ creator.name }}</span>
          </p>
          <p>时间: {{ formatterTime(slItem.publishTime) }}</p>
    ...
    <div class="mfsl_wrapper">
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="专辑详情" name="3">Role</el-tab-pane>
      </el-tabs>
    </div>
    <!-- E-歌单列表容器 -->
  </div>
...
export default {
  ...
  methods: {
    ...
    getSlItem() {
      ...
      console.log("传过来的歌单对象数据566", this.slItem);
      if (Object.keys(this.slItem).length > 0) {
        this.creator = this.slItem.artist;
